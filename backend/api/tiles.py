...
DBZH_CMAP = [
    ((-35.0, -30.0), (230, 230, 230, 60)),  # scanning area: subtle semi-transparent grey
    ((-30.0, -25.0), (204, 204, 204, 60)),
    ((-25.0, -20.0), (179, 179, 179, 60)),
    ((-20.0, -15.0), (153, 153, 153, 60)),
    ((-15.0, -10.0), (128, 128, 128, 60)),
    ((-10.0, -5.0),  (102, 102, 102, 60)),
    ((-5.0, 0.0),    (51, 51, 51, 60)),
    ((0.0, 5.0),     (10, 10, 92, 255)),    # deep navy blue
    ((5.0, 10.0),    (28, 28, 140, 255)),   # navy blue
    ((10.0, 15.0),   (51, 51, 188, 255)),   # blue
    ((15.0, 20.0),   (82, 82, 220, 255)),   # indigo / royal blue
    ((20.0, 25.0),   (77, 237, 77, 255)),   # light green
    ((25.0, 30.0),   (50, 200, 50, 255)),   # green
    ((30.0, 35.0),   (30, 150, 30, 255)),   # medium green
    ((35.0, 40.0),   (15, 94, 15, 255)),    # dark green
    ((40.0, 45.0),   (255, 224, 64, 255)),  # yellow
    ((45.0, 50.0),   (255, 168, 28, 255)),  # orange
    ((50.0, 55.0),   (225, 0, 0, 255)),     # red
    ((55.0, 60.0),   (160, 0, 0, 255)),     # dark red
    ((60.0, 65.0),   (90, 0, 0, 255)),      # maroon
    ((65.0, 70.0),   (200, 80, 200, 255)),  # pink / light purple
    ((70.0, 75.0),   (150, 30, 150, 255)),  # purple / magenta
    ((75.0, 80.0),   (230, 230, 230, 255)), # white / light grey
    ((80.0, 150.0),  (75, 75, 75, 255)),    # dark grey / black
]
RATE_CMAP = [
