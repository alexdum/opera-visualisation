...
DBZH_CMAP = [
    ...
    ((0.0, 15.0),    (0, 236, 236, 255)),   # cyan (< 15 dBZ)
    ((15.0, 20.0),   (0, 160, 240, 255)),   # light blue
    ((20.0, 25.0),   (0, 0, 240, 255)),     # dark blue
    ((25.0, 30.0),   (0, 255, 0, 255)),     # bright green
    ((30.0, 35.0),   (0, 192, 0, 255)),     # medium green
    ((35.0, 40.0),   (0, 128, 0, 255)),     # dark green
    ((40.0, 45.0),   (255, 255, 0, 255)),   # yellow
    ((45.0, 50.0),   (255, 128, 0, 255)),   # orange
    ((50.0, 55.0),   (255, 0, 0, 255)),     # red
    ((55.0, 60.0),   (192, 0, 0, 255)),     # dark red / maroon
    ((60.0, 65.0),   (255, 0, 255, 255)),   # magenta
    ((65.0, 150.0),  (153, 0, 153, 255)),   # purple
]
RATE_CMAP = [
