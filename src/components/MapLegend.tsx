...
export const MapLegend: React.FC<MapLegendProps> = ({ parameter, values }) => {
  ...
  return (
    <div className="hidden md:flex absolute bottom-8 left-4 bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-lg border border-slate-200 z-10 font-sans text-xs flex-col">
