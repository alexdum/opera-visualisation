...
export const MapLegend: React.FC<MapLegendProps> = ({ parameter, values }) => {
  ...
  return (
    <div className="hidden md:flex absolute top-1/2 -translate-y-1/2 left-6 bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-lg border border-slate-200 z-10 font-sans text-xs flex-col">
